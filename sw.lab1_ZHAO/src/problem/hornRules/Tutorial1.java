...
/*
 * constructs a rule base and a fact base of the knowledge base
 */
public class Tutorial1 extends Variable{
	...
	//string that contents the rules
	...
	Tutorial1() {
		...
		for(String r: rulestring){
			...
			//String[] split(String text) : boo:and:foo -> split(":") : { "boo", "and", "foo" }
